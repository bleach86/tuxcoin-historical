...
uint256 hashGenesisBlock("0xcf7938a048f1442dd34f87ce56d3e25455b22a44f676325f1ae8c7a33d0731c7");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Tuxcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Tuxcoin Signed Message:\n";
...
{
    // Tuxcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 42071); // Tuxcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60; // Tuxcoin: 1 minute
static const int64 nTargetSpacing = 60; // Tuxcoin: 1 minute
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Tuxcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x279f0fda784164aebbface8db434a8801748be987edb585d8025e58379d1b54f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0476929ca6904b40d59cc9af2907a050d5b8f332111b83aebfd6258a68dfb771895c96c1eeac808aeb083f5ec54a44dd282a6b34944fce8726c1980c1f06a6b69e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1529196636;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085541870;

        if (fTestNet)
        {
            block.nTime    = 1529196619;
            block.nNonce   = 388550749;
        }
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x3ead103523ad8f9bfc8365c7b5ddb6f10c731c6274730e88bcaa2c74606dd4bb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc5, 0xbf, 0xda }; // Tuxcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TuxcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TuxcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static TuxcoinMiner(CWallet *pwallet)
{
    printf("TuxcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("tuxcoin-miner");
    ...
    try { loop {
        ...
        printf("Running TuxcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TuxcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&TuxcoinMiner, pwallet));
}
