...
"Copyright &copy; 2018 Tuxcoin Developer"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Tuxcoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Tuxcoin</b> version", Q_NULLPTR));
